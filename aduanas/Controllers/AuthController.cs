...
namespace aduanas.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<ActionResult<RespuestaHttp<RespuestaAuth>>> Registrar([FromBody] UsuarioRegistro usuarioRegistro)
        {
            ...
            var usuario = new UserCustom { UserName = usuarioRegistro.email, Email = usuarioRegistro.email, UserNames= usuarioRegistro.usuario };
        ...
        public async Task<ActionResult<RespuestaHttp<RespuestaAuth>>> RenovarToke()
        {
            ...
            return new RespuestaHttp<RespuestaAuth>()
            {
                success = true,
                msg = "Token renovado",
                data = CostruirToken(usuarioRegistro, usuario.UserName),
            };
        }
